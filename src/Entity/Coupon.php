...
class Coupon
{
    ...
    #[ORM\ManyToOne(targetEntity: self::class, inversedBy: 'coupons')]
    #[ORM\JoinColumn(nullable: false)]
    private ?self $coupon_type = null;

    #[ORM\OneToMany(mappedBy: 'coupon_type', targetEntity: self::class, orphanRemoval: true)]
    ...
    public function getCouponType(): ?self
    {
        return $this->coupon_type;
    }

    public function setCouponType(?self $coupon_type): self
    {
    ...
    public function addCoupon(self $coupon): self
    {
    ...
    public function removeCoupon(self $coupon): self
    {
